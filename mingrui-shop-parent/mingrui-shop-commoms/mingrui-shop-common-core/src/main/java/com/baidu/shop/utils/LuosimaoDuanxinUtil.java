...
public class LuosimaoDuanxinUtil {
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-b3335a1fa83b919e8487ee89430f9388";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-81bf08f3a6e8d10ee3aa78c62c342ae1";//需要使用自己的APIkey
